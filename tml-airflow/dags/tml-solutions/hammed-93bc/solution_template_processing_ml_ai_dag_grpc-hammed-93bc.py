...
step3 = importlib.import_module("tml-solutions.hammed-93bc.tml_read_gRPC_step_3_kafka_producetotopic_dag-hammed-93bc")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-hammed-93bc_TEMPLATE_DO_NOT_USE",
