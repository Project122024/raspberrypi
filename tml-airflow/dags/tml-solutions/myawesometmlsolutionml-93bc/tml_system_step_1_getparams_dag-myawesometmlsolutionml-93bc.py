...
default_args = {
 ...
 'solutionname': 'myawesometmlsolutionml-93bc',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolutionml-93bc", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolutionml-93bc"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
