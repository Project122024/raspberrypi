...
default_args = {
  ...
  'mqtt_broker' : 'b4054d878b5a41268e3f9b5bd568bdc1.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_finalproject2-93bc", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_finalproject2-93bc"], schedule=None,catchup=False)
